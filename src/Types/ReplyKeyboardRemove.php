...
{
    /**
     * @var bool Requests clients to remove the custom keyboard (user will not be able to summon this keyboard;
    ...
    /**
     * @var bool|null Use this parameter if you want to remove the keyboard for specific users only. Targets:
