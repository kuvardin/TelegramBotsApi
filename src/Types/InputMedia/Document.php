...
class Document extends InputMedia
{
    ...
    /**
     * @var bool|null $disable_content_type_detection Disables automatic server-side content type detection for files
    ...
    public static function makeByArray(array $data): static
    {
        ...
        $result->disable_content_type_detection = $data['disable_content_type_detection'] ?? null;
        return $result;
    }
