...
class ChatAdministratorRights extends Type
{
     ...
     * @param bool $can_promote_members <em>True</em>, if the administrator can add new administrators with a subset
     ...
     * @param bool|null $can_edit_messages <em>True</em>, if the administrator can edit messages of other users
     *     and can pin messages; channels only
     * @param bool|null $can_pin_messages <em>True</em>, if the user is allowed to pin messages; groups and
     *     supergroups only
