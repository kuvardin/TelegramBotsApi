...
class Administrator extends ChatMember
{
     ...
     * @param bool $can_promote_members True, if the administrator can add new administrators with a subset of
     ...
     * @param bool|null $can_edit_messages True, if the administrator can edit messages of other users and
     *     can pin messages; channels only
     * @param bool|null $can_pin_messages True, if the user is allowed to pin messages; groups and supergroups
     *     only
